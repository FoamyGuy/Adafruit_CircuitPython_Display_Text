# SPDX-FileCopyrightText: 2020 Kevin Matocha, 2021 Foamyguy
#
...
Text graphics handling for CircuitPython, including text boxes. Does not
automatically resize itself to fit text. User must specify width and height.
...
class Label(displayio.Group):
    ...
    def _reset_text(
        ...
        self._place_text(
            ...
            self._font,
            self._line_spacing,
            0,  # TODO: calculate and allow alignments
            loose_y_offset,
        )
